...
def _build_result(
    *,
    ...
    has_text_layer = bool(page_count) and (text_page_count / page_count) >= MIN_TEXT_LAYER_PAGE_RATIO
    ...
    rejection_reason = None if is_supported_native_pdf else _rejection_reason(page_count, has_text_layer)
