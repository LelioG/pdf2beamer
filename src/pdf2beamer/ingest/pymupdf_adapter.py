    ...
    for raw_block in text_dict.get("blocks", []):
        ...
        text_blocks.append(
            TextBlock(
                ...
                text=block_text,
                bbox=_bbox_from_sequence(raw_block.get("bbox")) or BoundingBox(
                    x0=0.0,
                    y0=0.0,
                    x1=0.0,
                    y1=0.0,
...
def _extract_images(
    *,
    ...
    for image_index, image_info in enumerate(page.get_images(full=True)):
        ...
        bbox = _first_image_bbox(page=page, xref=xref, page_index=page_index, image_index=image_index, warnings=warnings)
