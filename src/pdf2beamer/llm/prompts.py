...
def build_slide_ir_prompt(
    ...
    lines = [
        ...
        'Visuals may include {"id": string, "type": "figure|table", "path": string|null, "caption": string|null, "content": string|null, "source_ids": []}.',
        'Do not invent visual paths, table contents, or visual contents; use only provided source ids.',
